  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`flex absolute transform-translate-x-1/2 cursor-pointer transition-all duration-2500 delay-600 bottom-[1rem] lg:bottom-[2rem] ${imageLoaded ? 'opacity-100' : 'opacity-0'} no-custom-cursor`}
