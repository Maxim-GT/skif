...
const weaponsData: Weapon[] = [
  {
    id: 1,
    name: "Карабин Сайга",
    shortDescription: "Учебное занятие, 1500 р.",
  ...
  },
  {
    ...
    shortDescription: "Учебное занятие, 3500 р.",
  ...
  },
  {
    ...
    shortDescription: "Учебное занятие, 3000 р.",
  ...
  },
  {
    ...
    shortDescription: "Учебное занятие, 4000 р.",
          ...
          {weaponsData.map((weapon) => (
            ...
            >
              ...
              <div className="p-4 sm:p-4 md:p-5 flex flex-col flex-grow">
                ...
                <p className="text-sm text-skif-charcoal/70 mb-4 flex-grow">
